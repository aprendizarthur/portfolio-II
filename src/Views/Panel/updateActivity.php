    ...
    <div class="row d-flex justify-content-around">
        <aside class="aside col-11 col-md-4 col-lg-3 text-light">
            <header class="p-3">
                ...
                <h1 class="d-inline ubuntu-regular">Editar Atividade</h1>
            </header>
            <hr>
            <section class="p-3" id="panel-nav">
                <nav>
                    <a class="d-inline-block btn btn-primary poppins-bold w-100" href="panel.php">Voltar</a>
                    <a class="d-inline-block mt-2 btn btn-danger poppins-bold w-100" href="deleteActivity.php?id=<?php echo (int)$_GET['id'];?>">Excluir</a>
                </nav>
            </section>
        </aside>
        ...
        <main class="main col-11 col-md-7 col-lg-8 text-light">
            ...
            <section class="p-3" id="update-user">
                <?php
                    try{
                        $ActivityController->Update($ActivityModel, $ActivityDAO, $SessionManager, $ActivityModel->getDataUpdateFromPost());
                    } catch (Exception $e){
